...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "ajiasu_bridge_offline_tip": "未收到爱加速桥的响应。请检查: 1) 桥接已安装  2) 爱加速已启动并打开主窗口  3) 如果任务管理器里是 HD_AJiaSu.exe,点 ⚙ → 自动 让工具锁定到运行中进程的目录,然后重新打补丁",
        "ajiasu_path_invalid": "安装目录无效(需包含 AJiaSu.exe 和 res.fvr)",
        "ajiasu_detected": "已检测到安装目录: {path}",
        "ajiasu_detected_running": "已锁定运行中爱加速的目录: {path}",
        "ajiasu_running_exe": "运行中的进程: {names} (打补丁会作用到这个目录的 res.fvr)",
        "ajiasu_detecting": "正在检测爱加速安装目录...",
        ...
        "ajiasu_patch_done_title": "桥接已安装",
        "ajiasu_patch_done_launch_msg": "桥接已成功安装。是否立即启动 AJiaSu.exe?\n\n(启动后请登录,等主窗口出来,顶部状态会变绿)",
        "ajiasu_launching": "正在启动 AJiaSu.exe...",
        "ajiasu_patch_overwritten": "⚠ 检测到 AJiaSu 已更新,补丁被覆盖 — 点这里重新安装",
        ...
        "switching_in_progress": "正在切换中,请稍候...",
        "interval_will_apply_next": "已保存,新间隔将在下个周期生效(或停止后重新启动)",
    ...
    "en_US": {
        ...
        "ajiasu_bridge_offline_tip": "No response from the AJiaSu bridge. Check: 1) bridge installed; 2) AJiaSu launched with main window open; 3) if Task Manager shows HD_AJiaSu.exe, click ⚙ → Auto so this tool locks onto the running process's dir, then re-patch.",
        "ajiasu_path_invalid": "Invalid install dir (needs AJiaSu.exe and res.fvr)",
        "ajiasu_detected": "Detected install dir: {path}",
        "ajiasu_detected_running": "Locked onto running AJiaSu's dir: {path}",
        "ajiasu_running_exe": "Running process: {names} (patch will target this dir's res.fvr)",
        "ajiasu_detecting": "Detecting AJiaSu install dir...",
        ...
        "ajiasu_patch_done_title": "Bridge installed",
        "ajiasu_patch_done_launch_msg": "Bridge installed successfully. Launch AJiaSu.exe now?\n\n(After launching, log in and wait for the main window. The top status will turn green.)",
        "ajiasu_launching": "Launching AJiaSu.exe...",
        "ajiasu_patch_overwritten": "⚠ AJiaSu was updated and the bridge was wiped — click to reinstall",
        ...
        "switching_in_progress": "A switch is already in progress...",
        "interval_will_apply_next": "Saved. New interval applies on next cycle (or after restart).",
